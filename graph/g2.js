...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__antv_g2__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__antv_g2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__antv_g2__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_1__antv_g2__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_1__antv_g2__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ChartVue = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('g2-chart', {
  props: _extends({
    configs: {
      type: Object,
      default: function _default() {
  ...
  methods: {
    ...
    createGraph: function createGraph() {
      ...
      // 保存引用
      this.core = new __WEBPACK_IMPORTED_MODULE_1__antv_g2__["Chart"](_extends({
        container: container
      }, configs));
      // 绑定事件
      this.bindEvents();

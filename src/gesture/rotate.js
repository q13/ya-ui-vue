...
var rotateRecognizer = {
  ...
  touchstart: function (event) {
    ...
    Recognizer.start(event, ya.noop);
    var finger;
    ...
    if (!('lastTouch' in finger)) {
      finger.lastTouch = finger.startTouch;
    }
    var el = finger.element;
    var docOff = dom(el).offset();
    rotateRecognizer.center = {
      // 求得元素的中心
